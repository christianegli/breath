...
echo "🚀 Creating working Breath Training App..."

# Create project directory structure
mkdir -p "Breath.xcodeproj"

# Create a working project.pbxproj (based on our successful minimal one)
cat > "Breath.xcodeproj/project.pbxproj" << 'EOF'
// !$*UTF8*$!
{
	archiveVersion = 1;
	classes = {
...
/* Begin PBXFileReference section */
		A1234567890123456789012E /* Breath.app */ = {isa = PBXFileReference; explicitFileType = wrapper.application; includeInIndex = 0; path = Breath.app; sourceTree = BUILT_PRODUCTS_DIR; };
...
/* Begin PBXGroup section */
		A1234567890123456789013A /* Breath */ = {
			isa = PBXGroup;
			children = (
		...
		A1234567890123456789013C /* Products */ = {
			isa = PBXGroup;
			children = (
				A1234567890123456789012E /* Breath.app */,
			);
			name = Products;
			sourceTree = "<group>";
		};
...
/* Begin PBXNativeTarget section */
		A1234567890123456789013D /* Breath */ = {
			isa = PBXNativeTarget;
			buildConfigurationList = A1234567890123456789013E /* Build configuration list for PBXNativeTarget "Breath" */;
			buildPhases = (
			...
			name = Breath;
			productName = Breath;
			productReference = A1234567890123456789012E /* Breath.app */;
...
/* Begin PBXProject section */
		A1234567890123456789014B /* Project object */ = {
			...
			buildConfigurationList = A1234567890123456789014C /* Build configuration list for PBXProject "Breath" */;
...
/* Begin XCConfigurationList section */
		A1234567890123456789013E /* Build configuration list for PBXNativeTarget "Breath" */ = {
		...
		A1234567890123456789014C /* Build configuration list for PBXProject "Breath" */ = {
			isa = XCConfigurationList;
			buildConfigurations = (
				A1234567890123456789014D /* Debug */,
				A1234567890123456789014E /* Release */,
...
mkdir -p "Breath.xcodeproj/project.xcworkspace"
cat > "Breath.xcodeproj/project.xcworkspace/contents.xcworkspacedata" << 'EOF'
<?xml version="1.0" encoding="UTF-8"?>
<Workspace
   version = "1.0">
   <FileRef
      location = "self:Breath.xcodeproj">
   </FileRef>
</Workspace>
EOF

# Create source directory structure with your comprehensive app files
mkdir -p "Breath"
mkdir -p "Breath/Preview Content/Preview Assets.xcassets"

# Copy all your comprehensive Swift files to the new project
cp Breath/BreathApp.swift Breath/
cp Breath/ContentView.swift Breath/

# Create preview assets
cat > "Breath/Preview Content/Preview Assets.xcassets/Contents.json" << 'EOF'
{
  "info" : {
    "author" : "xcode",
    "version" : 1
...
echo "📁 Project: $(pwd)/Breath.xcodeproj"
echo ""
